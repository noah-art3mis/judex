"""
Unit tests for the normalized database structure - direct import version.
"""
...
from lexicon.database import (
    init_database,
    save_processo_data,
    get_complete_processo_data,
    get_processo_andamentos,
    get_processo_partes,
    get_processo_decisoes,
    get_processo_deslocamentos,
    get_processo_peticoes,
    get_processo_recursos,
    get_processo_pautas
)
...
def sample_processo_data():
    ...
    return {
        ...
        "assuntos": ["DIREITO ADMINISTRATIVO E OUTRAS MATÉRIAS DE DIREITO PÚBLICO | Controle de Constitucionalidade"],
        "partes_total": [
        ...
        "andamentos": [
            {"index": 202, "data": "27/06/2025", "nome": "Petição", "complemento": "Procuração/Substabelecimento - Petição: 88567 Data: 27/06/2025, às 11:40:43", "julgador": None},
            {"index": 201, "data": "23/06/2025", "nome": "Petição", "complemento": "Amicus curiae - Petição: 85754 Data: 23/06/2025, às 16:38:18", "julgador": None},
            {"index": 200, "data": "18/03/2024", "nome": "Petição", "complemento": "Manifestação - Petição: 29642 Data: 18/03/2024, às 22:45:09", "julgador": None}
        ],
        "decisoes": [
            {"index": 125, "data": "28/11/2013", "nome": "Adotado rito do Art. 12, da Lei 9.868/99", "julgador": "MIN. CÁRMEN LÚCIA", "complemento": "em 21/11/2013: \"Rquisitem-se informações às autoridades requeridas...\"", "link": None}
        ],
        "deslocamentos": [
            {"index": 35, "data_enviado": "14/06/2023", "data_recebido": "14/06/2023", "enviado_por": "GERÊNCIA DE PROCESSOS", "recebido_por": "PRESIDÊNCIA", "guia": "123456"},
            {"index": 34, "data_enviado": "10/06/2023", "data_recebido": "12/06/2023", "enviado_por": "SECRETARIA JUDICIÁRIA", "recebido_por": "GABINETE", "guia": "123455"}
        ],
        "peticoes": [
            {"index": 83, "data": "Peticionado em 27/06/2025", "tipo": "88567/2025", "autor": None, "recebido_data": "27/06/2025 11:40:43", "recebido_por": "DIVISÃO DE PROCESSOS ORIGINARIOS"},
            {"index": 82, "data": "Peticionado em 23/06/2025", "tipo": "85754/2025", "autor": None, "recebido_data": "23/06/2025 16:38:18", "recebido_por": "DIVISÃO DE PROCESSOS ORIGINARIOS"}
        ],
        "recursos": [
            {"index": 125, "data": "28/11/2013", "nome": "Adotado rito do Art. 12, da Lei 9.868/99", "julgador": "MIN. CÁRMEN LÚCIA", "complemento": "em 21/11/2013", "autor": None}
        ],
        "pautas": [
            {"index": 109, "data": "13/05/2014", "nome": "Pauta publicada no DJE - Plenário", "complemento": "PAUTA Nº 22/2014. DJE nº 90, divulgado em 12/05/2014", "relator": "MIN. CÁRMEN LÚCIA"},
            {"index": 108, "data": "09/05/2014", "nome": "Inclua-se em pauta - minuta extraída", "complemento": "Pleno em 09/05/2014 14:13:39", "relator": "MIN. CÁRMEN LÚCIA"}
        ]
    }
...
class TestEdgeCases:
    ...
    def test_unicode_data(self, temp_db):
        ...
        unicode_data = {
            ...
            "andamentos": [
                {"index": 1, "data": "27/06/2025", "nome": "Petição", "complemento": "Procuração/Substabelecimento - Petição: 88567 Data: 27/06/2025, às 11:40:43", "julgador": None},
                {"index": 2, "data": "23/06/2025", "nome": "Petição", "complemento": "Amicus curiae - Petição: 85754 Data: 23/06/2025, às 16:38:18", "julgador": None}
            ],
            "decisoes": [
                {"index": 1, "data": "28/11/2013", "nome": "Adotado rito do Art. 12, da Lei 9.868/99", "julgador": "MIN. CÁRMEN LÚCIA", "complemento": "em 21/11/2013: \"Rquisitem-se informações às autoridades requeridas, que deverão prestá-las no prazo máximo de dez dias. Na seqüência, com base no art. 12 da Lei n. 9868/99, dê-se vista, sucessivamente, ao Advogado-eral da União e ao Procurador-Geral da República no prazo máximo de cnco dias a cada qual. Publique-se.\"", "link": None}
            ],
            "deslocamentos": [],
            "peticoes": [],
            "recursos": [],
